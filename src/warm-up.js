...
var vegetables = ['sweet potato', 'red onion', 'cauliflower', 'green beans', 'avocado'];
...
var fruits = ['lemon', 'banana', 'tomato', 'lime', 'blueberry', 'strawberry', 'kiwi'];
...
//Other key value pairs could include: storeHours, location, hasCurbsidePickup
